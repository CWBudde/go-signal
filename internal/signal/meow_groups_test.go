...
// openSeeded opens the seeded account's database until the end of the test.
func openSeeded(t *testing.T, dataDir string) *store.Store {
	t.Helper()
